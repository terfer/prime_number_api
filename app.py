...
try:
    open('data/list.data', 'r').readlines()[-1]
except:
...
def calculate_num_prime():
    first_number_calculated = int(open('data/list.data', 'r').readlines()[-1])
    data_new = len(open('data/list.data', 'r').read())
